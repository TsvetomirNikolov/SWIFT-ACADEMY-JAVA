...
--
-- Host: localhost    Database: softunijson
-- ------------------------------------------------------
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `buyer_id` FOREIGN KEY (`buyer_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `users` VALUES (5,'Tsvetomir','Nikolov',24);
...
-- Dump completed on 2017-08-03 16:55:39
