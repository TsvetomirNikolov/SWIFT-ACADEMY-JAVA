package pkg10.data.Task9_PersonCharacteristics;

import pkg10.data.Task9_PersonCharacteristicss.Education;
import pkg10.data.Task9_PersonCharacteristicss.PrimaryEducation;
import pkg10.data.Task9_PersonCharacteristicss.HigherEducation;
import pkg10.data.Task9_PersonCharacteristicss.SecondaryEducation;
import java.time.LocalDate;
import java.time.format.DateTimeFormatter;
import java.util.Scanner;

public class Task9_PersonCharacteristics {

    private DateTimeFormatter _formatter = DateTimeFormatter.ofPattern("d.M.yyyy");
    private Person[] _person;

    public Task9_PersonCharacteristics(int number) {
    ...
    public static void main(String[] args) {
        ...
        Task9_PersonCharacteristics educationInfo = new Task9_PersonCharacteristics(input);
